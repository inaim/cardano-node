...
makeTxWitnessPPDataHash
  ...
  => ShelleyBasedEra era
  -> ProtocolParameters era -- You can derive the script languages from here
...
makeTxWitnessPPDataHash sbe@ShelleyBasedEraAlonzo pParams rMap =
  maybeToStrictMaybe
    $ Alonzo.hashWitnessPPData
        (toShelleyPParams sbe  pParams)
        (error "Set Language")
        rMap
makeTxWitnessPPDataHash _ _ _ = SNothing
